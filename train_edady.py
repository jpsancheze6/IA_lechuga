...
data_entrenamiento = os.path.relpath('data/entrenamiento_fecha')     # Ruta de la carpeta de las imágenes de entrenamiento
data_validacion = os.path.relpath('data/validacion_fecha')           # Ruta de la carpeta de las imágenes de prueba o validación
...
clases = 7                                      # Número de elementos que se van a examinar (gato, perro, gorila)
...
dir = os.path.relpath('data/modelo_fecha/')

if not os.path.exists(dir):
    os.mkdir(dir)

red.save(os.path.relpath('data/modelo_fecha/modelo.h5'))                  # Guardar el modelo con los resultados
red.save_weights(os.path.relpath('data/modelo_fecha/pesos.h5'))           # Guardar los pesos del modelo
