...
data_entrenamiento = os.path.relpath('data/entrenamiento_lechuga')     # Ruta de la carpeta de las imágenes de entrenamiento
data_validacion = os.path.relpath('data/validacion_lechuga')           # Ruta de la carpeta de las imágenes de prueba o validación
...
clases = 3                                      # Número de elementos que se van a examinar (gato, perro, gorila)
...
dir = os.path.relpath('data/modelo_lechuga/')

if not os.path.exists(dir):
    os.mkdir(dir)

red.save(os.path.relpath('data/modelo_lechuga/modelo.h5'))                  # Guardar el modelo con los resultados
red.save_weights(os.path.relpath('data/modelo_lechuga/pesos.h5'))           # Guardar los pesos del modelo
