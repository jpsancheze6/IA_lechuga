...
data_entrenamiento = os.path.relpath('data/entrenamiento_clasificacion')     # Ruta de la carpeta de las imágenes de entrenamiento
data_validacion = os.path.relpath('data/validacion_clasificacion')           # Ruta de la carpeta de las imágenes de prueba o validación
...
dir = os.path.relpath('data/modelo_clasificacion/')

if not os.path.exists(dir):
    os.mkdir(dir)

red.save(os.path.relpath('data/modelo_clasificacion/modelo_clasificacion.h5'))                  # Guardar el modelo con los resultados
red.save_weights(os.path.relpath('data/modelo_clasificacion/pesos_clasificacion.h5'))           # Guardar los pesos del modelo
